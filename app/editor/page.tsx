...
import { getAllScenarios, createScenario, updateScenario, deleteScenario, getScenario, type Scenario } from '@/lib/scenario-api';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-[calc(100vh-60px)] mt-[60px]">
        <aside className="w-[350px] bg-white border-r border-gray-200 overflow-y-auto p-4 text-gray-800">
              ...
              {loading ? (
                ...
                scenarios.map((scenario) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 mb-2">{scenario.columns}×{scenario.rows}, {scenario.turns} turns</p>
                    <button
          ...
          <section className="mb-8 pb-8 border-b border-gray-200">
            <h2 className="text-xl font-semibold mb-4 text-gray-800">{isEditing ? 'Edit Scenario' : 'Create New Scenario'}</h2>
            <form>
              <div className="mb-4">
                <label htmlFor="scenario-title" className="block mb-2 font-medium text-gray-800">Title</label>
                <input
                  type="text"
                  id="scenario-title"
                  value={title}
              ...
              <div className="mb-4">
                <label htmlFor="scenario-description" className="block mb-2 font-medium text-gray-800">Description</label>
                <textarea
              ...
              <div className="flex gap-4 mb-4">
                <div className="flex-1">
                  <label htmlFor="scenario-columns" className="block mb-2 font-medium text-gray-800">Columns</label>
                  <input
                    type="number"
                    id="scenario-columns"
                    value={columns}
                ...
                <div className="flex-1">
                  <label htmlFor="scenario-rows" className="block mb-2 font-medium text-gray-800">Rows</label>
                  <input
                    type="number"
                    id="scenario-rows"
                    value={rows}
                ...
                <div className="flex-1">
                  <label htmlFor="scenario-turns" className="block mb-2 font-medium text-gray-800">Turns</label>
                  <input
                    type="number"
                    id="scenario-turns"
                    value={turns}
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 mt-4">Selected: <span className="font-medium">{selectedTerrain}</span></p>
          </section>
        </aside>
      ...
      {message && (
        <div className="fixed top-[70px] right-5 z-[10000]">
          <div className={`px-6 py-4 rounded shadow-lg animate-slideIn ${
